	...
	<div class="c-meta__rows">
		<div class="c-meta__row">
			<div class="c-meta__row-item">
				<?php echo do_blocks( '<!-- wp:novablocks/sharing-overlay {"buttonLabel":"' . esc_html__( 'Share', '__theme_txtd' ) . '", "useSourceColorAsReference":false,"paletteVariation":3} --><!-- /wp:novablocks/sharing-overlay -->' ); ?>
			</div>
			<div class="c-meta__row-item">
