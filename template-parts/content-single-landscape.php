...
$article_header_block =
	...
	'<!-- wp:novablocks/sidecar-area {"className":"novablocks-content article-header", "sidebarWidth":"medium"} -->' .
...
$article_content_block =
	'<!-- wp:novablocks/sidecar {"layout":"sidebar-right", "sidebarWidth":"medium" } -->' .
