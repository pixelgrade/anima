...
(function () {
  ...
  function extendControl ( control ) {
    if ( control.container.find( '.field-visual_style' ).length ) {
      ...
      let initialVisualStyle = updateVisualStyleControlFields( control );
    ...
    if ( control.container.find( '.field-badge' ).length ) {
      control.badgeField = control.container.find( '.field-badge' );
      ...
      // Set the initial UI state.
      let initialBadge = updateBadgeControlFields( control );
      // Update the initial setting value.
