...
function anima_customize_post_title_styling_field( array $config ): array {
	...
	$config['sections']['style_manager_section']['options']['sm_decorative_titles_style_intro'] = [
		...
		'html'         => '<div class="customize-control-title">' . esc_html__( 'Auto-style Post Titles', '__theme_txtd' ) . '</div>' .
			'<span class="description customize-control-description">' . esc_html__( 'Automatically gives post titles and supported collection card titles a more expressive typographic treatment, guided by punctuation and letter case.', '__theme_txtd' ) . '</span>',
	];
...
function anima_maybe_invalidate_post_title_styling_customizer_cache(): void {
	...
	$has_expected_field = (
		...
		&& false !== strpos( (string) ( $intro['html'] ?? '' ), 'Automatically gives post titles and supported collection card titles a more expressive typographic treatment, guided by punctuation and letter case.' )
		&& ( $field['type'] ?? '' ) === 'sm_toggle'
		&& ( $field['setting_type'] ?? '' ) === 'option'
		&& ( $field['setting_id'] ?? '' ) === 'sm_decorative_titles_style'
		&& ( $field['label'] ?? '' ) === esc_html__( 'Enabled', '__theme_txtd' )
		&& empty( $field['desc'] )
