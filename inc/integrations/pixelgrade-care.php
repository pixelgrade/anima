...
function rosa2_pixcare_install_page() {
	...
	<head>
		...
		<style>.btn--action, .btn--small, .btn--text, html, p {
			...
			.pixelgrade_care-wrapper {
				max-width: 730px;
				margin: 50px auto
			}

			.pixelgrade_care-wrapper, .pixelgrade_care-wrapper * {
				box-sizing: border-box
			}

			.dashboard-tabs > :first-child, .section {
				background: #fff;
				border: 1px solid #ddd
			}

			.setup-wizard-theme-name, .u-text-center {
				text-align: center
			}
			...
			.setup-wizard-theme-name, .theme__name, .theme__status {
				font-family: '-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol"', sans-serif;
				color: #23282d
			}
			...
			.header-toolbar__wing {
				display: flex;
				align-items: center
			}

			.header-toolbar__wing--right .btn {
				opacity: 1
			}

			.header-toolbar__wing--right .btn:last-child {
				padding-right: 0
			}
			...
			.section--informative .section__title {
				margin: 0;
				font-size: 36px;
				font-weight: 700;
				line-height: 49px
			...
			.section--informative .section__content {
				margin: 20px 0 30px
			}
			...
			.section :last-child, .section ul li:last-child {
				margin-bottom: 0
			}
			...
			.section--airy .section__subtitle {
				margin-top: 0;
				margin-bottom: 5px;
				font-size: 18px;
				font-weight: 600;
			...
			.faq-question p, .sections-grid .section {
				margin-top: 0
			}
			...
			.sections-grid .section__title {
				margin-bottom: 20px;
				font-size: 18px;
				line-height: 24px
			}

			.sections-grid .section__content {
				margin: 0 0 22px;
				font-size: 14px;
				line-height: 23px
			}
			...
			.box--error, .box--info, .box--validated, .box--warning {
				border: 0;
				color: #fff
			}
			...
			.box--plugin-activating:before, .box--plugin-installing:before, .box--plugin-missing:before {
				width: 6px;
				height: 6px;
				border: 7px solid;
				border-radius: 50%
			...
			.box--plugin-activating, .box--plugin-installing {
				border: 0;
			...
			.box--plugin-activating:before, .box--plugin-installing:before {
				border-color: #fff;
				background-color: #41B273
			}
			...
			.box--plugin-invalidated, .box--plugin-validated {
				transition: color .3s ease-in-out
			}

			.box--plugin-invalidated:after, .box--plugin-validated:after {
				content: "";
				position: absolute;
				top: 0;
				left: 0;
			...
			.box--plugin-installing:nth-child(2):after {
				transition-delay: 4s
			}

			.box--plugin-installing:nth-child(3):after {
				transition-delay: 6s
			}

			.box--plugin-installing:nth-child(4):after {
				transition-delay: 8s
			}

			.box--plugin-installing:nth-child(5):after {
				transition-delay: 10s
			}

			.box--plugin-installing:nth-child(6):after {
				transition-delay: 12s
			}

			.box--plugin-installing:nth-child(7):after {
				transition-delay: 14s
			}

			.box--plugin-installing:nth-child(8):after {
				transition-delay: 16s
			}

			.box--plugin-installing:nth-child(9):after {
				transition-delay: 18s
			}

			.box--plugin-installing:nth-child(10):after {
				transition-delay: 20s
			}

			.box--plugin-installing:nth-child(11):after {
				transition-delay: 22s
			}

			.box--plugin-installing:nth-child(12):after {
				transition-delay: 24s
			}

			.box--plugin-installing:nth-child(13):after {
				transition-delay: 26s
			}

			.box--plugin-installing:nth-child(14):after {
				transition-delay: 28s
			}

			.box--plugin-installing:nth-child(15):after {
				transition-delay: 30s
			}

			.box--plugin-installing:nth-child(16):after {
				transition-delay: 32s
			}

			.box--plugin-installing:nth-child(17):after {
				transition-delay: 34s
			}

			.box--plugin-installing:nth-child(18):after {
				transition-delay: 36s
			}

			.box--plugin-installing:nth-child(19):after {
				transition-delay: 38s
			}

			.box--plugin-installing:nth-child(20):after {
			...
			.box--plugin-installed.box--plugin-installed:after {
				transition-delay: 0s
			}
			...
			.box--plugin-activating.box--plugin-activating:after {
				transition-delay: 0s
			}
			...
			.pixelgrade_care-setup {
				margin: 0;
				padding: 100px 0;
				background-color: #f3f7f8
			}

			.pixelgrade_care-setup .pixelgrade_care-wrapper {
				margin-top: 0
			}

			.pixelgrade_care-setup .btn--small {
				padding: 12px 55px;
				background-color: #00a9de
			}

			.pixelgrade_care-setup .btn--small:hover {
				background-color: #23282d
			}

			.btn--return-to-dashboard, .stepper__label-name {
				font-size: 16px;
				font-weight: 600;
				text-align: center
			}
