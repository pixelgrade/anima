...
add_filter( 'style_manager/theme_fonts', 'rosa2_add_style_manager_theme_fonts' );

// Add fonts section and options to the Style Manager config
add_filter( 'style_manager/filter_fields', 'rosa2_add_fonts_section_to_style_manager_config', 60, 1 );

function rosa2_add_style_manager_theme_fonts( $fonts ) {
...
function rosa2_add_fonts_section_to_style_manager_config( $config ) {
