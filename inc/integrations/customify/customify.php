		...
		'header_section' => array(
			...
			'options' => array(
				...
				'header_position'                 => array(
					...
					'desc'    => esc_html__( 'Choose if you want a static or fixed (sticky) Header that stays visible no matter how much you scroll the page.
						——————————————————
						Note: to prevent your content from being annoyingly hidden behind the Header on smaller screens, the Sticky option will remain active only if the Header height is larger than one-fifth of the browser window height.
