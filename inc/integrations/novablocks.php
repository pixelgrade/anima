		...
		'fineTune'     => [
			[
				...
				'controls' => [
					...
					[
						'attribute' => 'latticeLandscapeSpan',
						'type'      => 'radio',
						'label'     => __( 'Landscape Width', '__theme_txtd' ),
						'help'      => __( 'Set regular landscape media to one or two shared columns.', '__theme_txtd' ),
						'options'   => [
							[ 'label' => __( 'Compact 1 column', '__theme_txtd' ), 'value' => 1 ],
							[ 'label' => __( 'Wide 2 columns', '__theme_txtd' ), 'value' => 2 ],
						],
					],
					[
						'attribute' => 'latticePortraitSpan',
						'type'      => 'radio',
						'label'     => __( 'Portrait Height', '__theme_txtd' ),
						'help'      => __( 'Let portrait media stay in one shelf row or rise through two.', '__theme_txtd' ),
						'options'   => [
							[ 'label' => __( 'Standard 1 row', '__theme_txtd' ), 'value' => 1 ],
							[ 'label' => __( 'Tall 2 rows', '__theme_txtd' ), 'value' => 2 ],
						],
					],
					[
						'attribute' => 'latticeTextPlateSpan',
						'type'      => 'radio',
						'label'     => __( 'Text Plate Width', '__theme_txtd' ),
						'help'      => __( 'Set media-less typographic plates to one or two shared columns.', '__theme_txtd' ),
						'options'   => [
							[ 'label' => __( 'Compact 1 column', '__theme_txtd' ), 'value' => 1 ],
							[ 'label' => __( 'Wide 2 columns', '__theme_txtd' ), 'value' => 2 ],
						],
					...
					[
						'attribute' => 'latticeQuoteSpan',
						'type'      => 'radio',
						'label'     => __( 'Quote Plate Width', '__theme_txtd' ),
						'help'      => __( 'Set quote plates to one or two shared columns.', '__theme_txtd' ),
						'options'   => [
							[ 'label' => __( 'Compact 1 column', '__theme_txtd' ), 'value' => 1 ],
							[ 'label' => __( 'Wide 2 columns', '__theme_txtd' ), 'value' => 2 ],
						],
