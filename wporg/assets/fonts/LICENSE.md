...
All fonts bundled here are licensed under the **SIL Open Font License, Version 1.1**
(GPL-compatible), borrowed from the Style Manager font palettes (Google/OFL subset).
Each is the `latin` subset, self-hosted (no remote requests).
