...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"1.4rem","bottom":"1.4rem"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:1.4rem;padding-bottom:1.4rem">
	...
	<div class="wp-block-group alignwide">
		<!-- wp:group {"style":{"spacing":{"blockGap":"0.15rem"}}} -->
		...
		<!-- wp:group {"style":{"spacing":{"blockGap":"0.9rem"}},"layout":{"type":"flex","flexWrap":"wrap","verticalAlignment":"center"}} -->
		<div class="wp-block-group">
			<!-- wp:navigation {"overlayMenu":"mobile","fontSize":"small","style":{"typography":{"letterSpacing":"0.04em"}},"layout":{"type":"flex","justifyContent":"right","flexWrap":"wrap"}} /-->
			...
			<div class="wp-block-group has-border-color" style="border-color:#0000002e;border-width:1px;border-radius:4px;padding-top:0.15rem;padding-right:0.6rem;padding-bottom:0.15rem;padding-left:0.6rem">
				...
				<p class="has-secondary-color has-text-color has-small-font-size" style="text-transform:uppercase;letter-spacing:0.08em"><?php esc_html_e( 'core/navigation', '__theme_txtd' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
