...
<div class="wp-block-group" style="padding-top:3.5rem;padding-bottom:1.5rem">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="flex-basis:46%">
			...
			<div class="wp-block-group">
				...
				<p class="has-secondary-color has-text-color has-small-font-size">Set in Space Grotesk, coloured by Morning Glory, spaced at 1.5× — and all of it yours to change.</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-column" style="flex-basis:27%">
			...
			<div class="wp-block-group">
				...
				<p class="has-primary-color has-text-color has-small-font-size" style="text-transform:uppercase;letter-spacing:0.16em">Explore</p>
				<!-- /wp:paragraph -->

				<!-- wp:navigation {"overlayMenu":"never","fontSize":"small","layout":{"type":"flex","orientation":"vertical"}} -->
				<!-- wp:navigation-link {"label":"Home","url":"/"} /-->

				<!-- wp:navigation-link {"label":"Design","url":"#"} /-->

				<!-- wp:navigation-link {"label":"Travel","url":"#"} /-->
				<!-- /wp:navigation -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-column" style="flex-basis:27%">
			...
			<div class="wp-block-group">
				<!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.16em"}},"textColor":"primary","fontSize":"small"} -->
				<p class="has-primary-color has-text-color has-small-font-size" style="text-transform:uppercase;letter-spacing:0.16em">More</p>
				<!-- /wp:paragraph -->

				<!-- wp:navigation {"overlayMenu":"never","fontSize":"small","layout":{"type":"flex","orientation":"vertical"}} -->
				<!-- wp:navigation-link {"label":"Stories","url":"#"} /-->
	...
	<div class="wp-block-group alignwide" style="border-top-color:#0000002e;border-top-width:1px;padding-top:1.2rem">
		...
		<p class="has-small-font-size"><a href="https://wordpress.org">Proudly powered by WordPress</a>.</p>
		<!-- /wp:paragraph -->
