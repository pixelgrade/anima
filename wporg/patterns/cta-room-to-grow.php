...
<section class="wp-block-group alignfull" style="padding-top:2.5rem;padding-bottom:2rem">
	...
	<div class="wp-block-group has-tertiary-background-color has-background" style="border-radius:10px;padding-top:3rem;padding-right:2rem;padding-bottom:3rem;padding-left:2rem">
		...
		<h2 class="wp-block-heading has-text-align-center has-x-large-font-size">Room to grow</h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center">Anima is complete on its own. When you’re ready for richer layouts and ready-made sections, the free Nova Blocks plugin picks up exactly where the theme leaves off.</p>
		<!-- /wp:paragraph -->

		<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
		<div class="wp-block-buttons">
			<!-- wp:button -->
			<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://wordpress.org/plugins/nova-blocks/">Get Nova Blocks</a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->

		<!-- wp:paragraph {"align":"center","textColor":"secondary","fontSize":"small"} -->
		<p class="has-text-align-center has-secondary-color has-text-color has-small-font-size">Anima is the foundation of Pixelgrade LT — Pixelgrade’s design system for WordPress.</p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</section>
