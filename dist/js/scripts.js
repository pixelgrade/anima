...
var utils_toggleLightClasses = function toggleLightClasses(element) {
  ...
  if (currentPaletteConfig) {
    ...
    var isLight = w('#FFFFFF').contrast(hex) < w('#000000').contrast(hex);
...
function () {
  ...
  createClass_default()(App, [{
    ...
    value: function initializeHeader() {
      ...
      var stickyHeader = document.querySelector('.novablocks-header--sticky');
