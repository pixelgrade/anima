...
function syncBodyClasses(html) {
  ...
  if (nobodyClass) {
    external_jQuery_default()('body').attr('class', nobodyClass);
  }
}
...
function reinitComponents() {
  ...
  const $images = external_jQuery_default()('[data-barba="container"]').find('img').not('[srcset], .is-loaded, .is-broken');
  if ($images.length && (external_jQuery_default()).fn.imagesLoaded) {
...
function createBorderInTimeline() {
  ...
  timeline.fromTo('.novablocks-hero .nb-supernova-item__inner-container, .nb-supernova--card-layout-stacked.nb-supernova--1-columns.nb-supernova--align-full .nb-supernova-item__inner-container', {
    opacity: 0,
    y: 50
  }, {
    opacity: 1,
  ...
  timeline.fromTo('.novablocks-hero .nb-supernova-item__media-wrapper, .nb-supernova--card-layout-stacked.nb-supernova--1-columns.nb-supernova--align-full .nb-supernova-item__media-wrapper', {
    scale: 1.2
  }, {
    scale: 1,
    duration: 0.4,
...
function playLoadingAnimation() {
  ...
  // Hero content fades in.
  gsap.fromTo('.novablocks-hero .nb-supernova-item__inner-container, .nb-supernova--card-layout-stacked.nb-supernova--1-columns.nb-supernova--align-full .nb-supernova-item__inner-container', {
    opacity: 0,
    y: 50
  }, {
    opacity: 1,
  ...
  // Hero background scales down.
  gsap.fromTo('.novablocks-hero .nb-supernova-item__media-wrapper, .nb-supernova--card-layout-stacked.nb-supernova--1-columns.nb-supernova--align-full .nb-supernova-item__media-wrapper', {
    scale: 1.2
  }, {
    scale: 1,
    duration: 0.4,
...
function init() {
  ...
  barba_umd_default().hooks.on('page:error', ({
    url
  }) => {
