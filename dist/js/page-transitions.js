...
class BottomActionBar {
  ...
  scan() {
    ...
    if (this.resizeObserver) {
      ...
      bars.filter(bar => !this.bars.includes(bar)).forEach(bar => this.resizeObserver.observe(bar, {
        box: 'border-box'
      }));
    }
...
function findProperElement(element, previous) {
  ...
  if (element.classList.contains('nb-sidecar') && element.children.length === 1 && element.firstElementChild.classList.contains('nb-sidecar-area--content')) {
 ...
 */
function createHeaderColorSignal({
  getWindow = () => window
} = {}) {
  ...
  function findHeader(container, win) {
    const scope = container && typeof container.querySelector === 'function' ? container : win && win.document;
...
var barba_umd = __webpack_require__(273);
...
var hero_motion = __webpack_require__(359);
...
var hero_init_filter = __webpack_require__(98);
...
var site_frame = __webpack_require__(776);
...
function apply3dClasses(el) {
  ...
  items.forEach((item, index) => {
    item.classList.toggle('js-3d', !item.matches(EXTERNAL_ITEM_SELECTOR) && matchesPilePattern({
      index,
      columns,
      target3d,
      rule3d
...
var intro_animations = __webpack_require__(17);
var intro_animations_default = /*#__PURE__*/__webpack_require__.n(intro_animations);
;// ./src/js/components/collection-header-integration/index.js
const {
  getSharedCollectionHeaderIntegrationRuntime
} = __webpack_require__(144);
class CollectionHeaderIntegration {
  constructor(options = {}) {
    this.runtime = getSharedCollectionHeaderIntegrationRuntime(options);
  }
}
// EXTERNAL MODULE: ./src/js/components/bottom-action-bar.js
var bottom_action_bar = __webpack_require__(534);
var bottom_action_bar_default = /*#__PURE__*/__webpack_require__.n(bottom_action_bar);
...
class App {
  ...
  initializeBottomActionBar() {
    if (!App.bottomActionBar) {
      App.bottomActionBar = new (bottom_action_bar_default()).BottomActionBar();
...
// EXTERNAL MODULE: ./src/js/components/page-transitions/registry.js
var registry = __webpack_require__(118);
...
function registerDefaultIntegrations() {
  ...
  (0,registry.register)(createHeaderColorSignal());
...
function reinitComponents(container) {
  ...
  return new Promise(resolve => {
    ...
    reinitNovaBlocksScripts(() => {
      ...
      (0,registry.runReinit)(container);
...
function cleanupBeforeTransition(container) {
  ...
  // (anima:before-swap).
  (0,registry.runCleanup)(container);
}
...
function performEnter({
  ...
  (0,registry.notifyAfterSwap)(next.container);
