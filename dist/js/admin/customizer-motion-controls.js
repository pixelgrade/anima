...
const MOTION_TOGGLE_SETTING_IDS = ['sm_page_transitions_enable', 'sm_intro_animations_enable'];
...
const MOTION_DEPENDENT_CONTROLS = {
  sm_page_transitions_enable: ['sm_page_transition_style', 'sm_logo_loading_style', 'sm_transition_symbol'],
  sm_intro_animations_enable: ['sm_intro_animations_style', 'sm_intro_animations_speed']
};
