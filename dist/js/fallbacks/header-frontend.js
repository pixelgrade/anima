...
(function ($, window, undefined) {
  var $siteHeader = $('.site-header--main'),
      $stickyHeader = $('.site-header--secondary');
  var stickyHeaderShown = false,
      mainHeaderShouldBeSticky = $('.site-header--main[data-sticky]').length && !$stickyHeader.length;
  $(window).on('scroll', makeHeaderStickyOnScroll); // This function will add .social-menu-item class
  // on menu-items if it's needed.

  function addSocialMenuClass() {
    var menuItem = document.querySelectorAll('.site-header__menu .menu-item a');
  ...
  addSocialMenuClass(); // We are using this function when
